# PureCPP
This is an open-source modular RAG (Retrieval-Augmented Generation) system developed by me over PureAI, integrating C++ and Python for high-performance vector processing and queries.
